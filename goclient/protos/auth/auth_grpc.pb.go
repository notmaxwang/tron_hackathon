...
const (
	AuthenticationService_Login_FullMethodName    = "/keyfi_protos.auth.AuthenticationService/Login"
	AuthenticationService_Register_FullMethodName = "/keyfi_protos.auth.AuthenticationService/Register"
)
