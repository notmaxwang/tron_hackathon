...
/**
 * @generated from protobuf message keyfi_protos.ai.SinglePromptRequest
 */
...
/**
 * @generated from protobuf message keyfi_protos.ai.SinglePromptResponse
 */
...
class SinglePromptRequest$Type extends MessageType<SinglePromptRequest> {
    constructor() {
        super("keyfi_protos.ai.SinglePromptRequest", [
...
/**
 * @generated MessageType for protobuf message keyfi_protos.ai.SinglePromptRequest
 */
...
class SinglePromptResponse$Type extends MessageType<SinglePromptResponse> {
    constructor() {
        super("keyfi_protos.ai.SinglePromptResponse", [
...
/**
 * @generated MessageType for protobuf message keyfi_protos.ai.SinglePromptResponse
 */
export const SinglePromptResponse = new SinglePromptResponse$Type();
/**
 * @generated ServiceType for protobuf service keyfi_protos.ai.AIService
 */
export const AIService = new ServiceType("keyfi_protos.ai.AIService", [
